...
pengobatan = {
    ...
    'D06': ('jenis jerawat yang terbentuk di bawah permukaan kulit, terasa keras, dan tidak memiliki kepala yang terlihat. Hindari paparan sinar matahari dan gunakan produk anti-inflamasi. \n'
            '\n**Solusi:**\n'
